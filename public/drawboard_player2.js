document.addEventListener('DOMContentLoaded', function() {
    ...
    let drawingDataPlayer2 = { head: '', body: '', legs: '' }; // Drawing data for Player 2
    ...
    function nextStep() {
        ...
        if (currentStep === 0) {
            drawingDataPlayer2.head = dataURL; // Store head drawing for Player 2
        } else if (currentStep === 1) {
            drawingDataPlayer2.body = dataURL; // Store body drawing for Player 2
        } else if (currentStep === 2) {
            drawingDataPlayer2.legs = dataURL; // Store legs drawing for Player 2
        }
    ...
    sendButton.addEventListener('click', function() {
        ...
        // Send drawing data to the results page for Player 2
        localStorage.setItem('drawingDataPlayer2', JSON.stringify(drawingDataPlayer2));
